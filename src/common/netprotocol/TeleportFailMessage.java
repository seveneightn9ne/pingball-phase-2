 ...
 * Message sent when a teleport has failed.
 * This is an immutable class.
 *
 * Thread Safety Argument:
 * - all data is immutable.
 */
public class TeleportFailMessage extends NetworkMessage {
    /**
     * Rep invariant:
    ...
    public static NetworkMessage deserialize(String body) throws DecodeException {
        ...
        return new TeleportFailMessage(ballVel, boardFrom, portalFrom, boardTo, portalTo);
    }
      ...
      * @param portalTo
      */
    public TeleportFailMessage(Vect ballVel, String boardFrom, String portalFrom, String boardTo, String portalTo) {
