 ...
 * The velocity of the ball and identifying information about the portal are cached when the message is constructed.
 *
 * Thread Safety Argument:
 * - all data is immutable.
 */
public class TeleportOutMessage extends NetworkMessage {
    /**
     * Rep invariant:
    ...
    public static NetworkMessage deserialize(String body) throws DecodeException {
        ...
        return new TeleportOutMessage(ballVel, boardFrom, portalFrom, boardTo, portalTo);
    }
      ...
      * @param portalTo
      */
    public TeleportOutMessage(Vect ballVel, String boardFrom, String portalFrom, String boardTo, String portalTo) {
